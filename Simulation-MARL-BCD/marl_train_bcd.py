...
if IS_TRAIN:
    ...
    y8 = record_reward_[6, :]
    y9 = record_reward_[7, :]
    np.save('Data2/8_users/3-BCD_User0_Reward_1000.npy', y2)
    np.save('Data2/8_users/3-BCD_User1_Reward_1000.npy', y3)
    np.save('Data2/8_users/3-BCD_User2_Reward_1000.npy', y4)
    np.save('Data2/8_users/3-BCD_User3_Reward_1000.npy', y5)
    np.save('Data2/8_users/3-BCD_User4_Reward_1000.npy', y6)
    np.save('Data2/8_users/3-BCD_User5_Reward_1000.npy', y7)
    np.save('Data2/8_users/3-BCD_User6_Reward_1000.npy', y8)
    np.save('Data2/8_users/3-BCD_User7_Reward_1000.npy', y9)
    np.save('Data2/8_users/3-BCD_Reward_MADDPG_1000.npy', record_global_reward_average)
